                ...
                <div class="row">
                  <div class="col-md-4 col-12 mb-1">
                    <fieldset class="form-group">
                      ...
                      <input type="text" class="form-control" id="basicInput"  placeholder="Enter name" name="name" value="{{$user->name}}">
                    </fieldset>
                  </div>
                  <div class="col-md-4 col-12 mb-1">
                    <fieldset class="form-group">
                      <label for="basicInput">Email</label>
                      <input type="email" class="form-control" id="basicInput2"  placeholder="Enter Email" name="email" value="{{$user->email}}">
                    </fieldset>
                  </div>
                  <div class="col-md-4 col-12 mb-1">
                    <fieldset class="form-group">
